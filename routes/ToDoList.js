...
ROUTER.use('/', express.static(path.resolve('public/todolistapp')));


ROUTER.get('/static', function(req, res) {		console.log("Get request made to /ToDoList "); 
	res.sendFile(path.resolve('public/todolistapp/index.html') );
});
...
ROUTER.get('/table/', function (request, res) { 		
...
ROUTER.post('/recive_form/', function (request, res) {  		console.log("\n Recived one POST to recive_form. ");	
...
ROUTER.post('/delete_task/', function (request, res) {  console.log("\n Recived one POST to delete_task.");	
	try {
		var db = new sqlite3.Database(file);
...
ROUTER.post('/ChangeComplete/', function (req, res) { 		
	try {
...
ROUTER.post('/AddNote/', function (req, res) { console.log("\n POST to AddNote.");	
